...
public class DataFlowNodeFactorySummary implements Serializable
{
    ...
    public DataFlowNodeFactorySummary(String name, Boolean dataSourceFactory, Boolean dataSinkFactory, Boolean dataProcessorFactory, Boolean dataServiceFactory, Boolean dataStoreFactory)
    {
        _name                 = name;
