        ...
        try
        {
            if ((serviceRootURL != null) && (requesterId != null) && (userId != null))
            {
                ...
                if (response.getStatus() == HttpResponseCodes.SC_OK)
                {
                    ...
                    logger.log(Level.FINE, "Received (blob) 'adverts' number " + advertNodeDTOs.size());
