...
public class StoreSetup implements Serializable
{
    ...
    public void setup()
    {
        ...
        {
            _dataBrokerUtils.createDataBroker("SMN - Arjuna", "Newcastle City Council Speed Management Network (Arjuna)", "http://localhost:80", "arjuna");
            _dataBrokerUtils.createDataBroker("SMN - OpenShift", "Newcastle City Council Speed Management Network (OpenShift)", "http://localhost:8080/", "arjuna");
            _dataBrokerUtils.createDataBroker("Soft-DB - OpenShift", "Sunderland City Council Geodata (OpenShift)", "http://localhost:8080/", "arjuna");
        }
