...
public class AdvertNodeVO implements Serializable
{
    ...
    public AdvertNodeVO(String nodeClass, String name, String summary, String discription, Date dataCreated, Date dateUpdate, String owner, List<String> tags, List<AdvertNodeVO> childNodes)
    {
