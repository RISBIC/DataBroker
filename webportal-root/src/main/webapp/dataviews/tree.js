...
// size of the diagram
var viewerWidth = Math.floor(jQuery('body').width()*79/100);
...
function click(d) {
    ...
    console.log(d);
    fieldsModel.fields.removeAll();

    var excludedProperties = ['_children', 'children', 'depth', 'id', 'parent', 'x', 'x0', 'y', 'y0', 'isRootNode', 'metadataPath', 'metadataId', 'requesterId', 'serviceURL'];
